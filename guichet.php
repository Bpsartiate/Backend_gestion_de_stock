...
<html lang="en-US" dir="ltr">
  ...
  <body>
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            <div class="card-body d-flex justify-content-between align-items-center">
              <div>
                <h6 class="text-primary">Gestion des Guichets</h6>
                <p class="mb-0 text-600">Lister, créer et éditer les guichets</p>
              </div>
              <div>
                <button id="btnAddGuichetPage" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalCreateGuichetPage">Ajouter Guichet</button>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <div id="guichetsPageList" class="list-group" style="min-height:200px;">
                    <div class="p-3 text-center">
                      <div class="spinner-border text-primary" role="status"><span class="visually-hidden">Chargement...</span></div>
                      <div class="mt-2 text-muted">Chargement des guichets...</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <!-- Modal -->
          <div class="modal fade" id="modalCreateGuichetPage" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-md">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Créer un Guichet</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                  <form id="formCreateGuichetPage">
                    <div class="mb-2"><label class="form-label">Nom du guichet</label><input class="form-control" name="nom_guichet" /></div>
                    <div class="mb-2"><label class="form-label">Magasin associé (ID)</label><input class="form-control" name="magasinId" /></div>
                  </form>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                  <button id="submitCreateGuichetPage" type="button" class="btn btn-primary">Créer</button>
                </div>
              </div>
            </div>
          </div>
   ...
   <!-- ===============================================-->
    ...
    <script src="assets/js/guichet.js"></script>
  </body>
</html>