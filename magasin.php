...
<html lang="en-US" dir="ltr">
  ...
  <body>
        ...
        <div class="content">
          ...
          <div class="card mb-3">
            <div class="card-body d-flex justify-content-between align-items-center">
              <div>
                <h6 class="text-primary">Gestion des Magasins</h6>
                <p class="mb-0 text-600">Lister, créer et éditer les magasins</p>
              </div>
              <div>
                <button id="btnAddMagasinPage" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalCreateMagasinPage">Ajouter Magasin</button>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                <div class="card-body">
                  <div id="magasinsPageList" class="list-group" style="min-height:200px;">
                    <div class="p-3 text-center">
                      <div class="spinner-border text-primary" role="status"><span class="visually-hidden">Chargement...</span></div>
                      <div class="mt-2 text-muted">Chargement des magasins...</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <!-- Modal -->
          <div class="modal fade" id="modalCreateMagasinPage" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-md">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form id="formCreateMagasinPage">
                    <div class="mb-2"><label class="form-label">Nom du magasin</label><input class="form-control" name="nom_magasin" /></div>
                    <div class="mb-2"><label class="form-label">Adresse</label><input class="form-control" name="adresse" /></div>
                    <div class="mb-2"><label class="form-label">Téléphone</label><input class="form-control" name="telephone" /></div>
                  </form>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Annuler</button>
                  <button id="submitCreateMagasinPage" type="button" class="btn btn-primary">Créer</button>
                </div>
              </div>
            </div>
          </div>
    ...
    <script src="vendors/simplebar/simplebar.min.js"></script>
    <script src="assets/js/magasin.js"></script>
  </body>
</html>